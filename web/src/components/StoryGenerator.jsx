        ...
        <div className="bg-white rounded-3xl shadow-2xl p-8">
          <div className="space-y-6">
            ...
            <button
              ...
              className={`w-full py-4 px-6 rounded-2xl font-body font-bold text-xl text-white transform transition-all duration-200 ${
                isGenerating
            ...
            <div className="flex gap-2 items-center">
              ...
              <span className="text-gray-600 font-body font-semibold text-md">No ideas? No problem! Leave the fields below blank and we'll conjure up a random magical tale for you.</span>
            </div>
            <div className="flex gap-2 items-center">
              <HiOutlineSparkles style={{ color: 'gold', fontSize: '24px' }} />
              <span className="text-xl font-heading font-semibold text-gray-600">
            ...
            <textarea
                ...
                className="w-full px-4 py-3 text-lg font-body border-2 border-purple-300 rounded-2xl focus:outline-none focus:border-purple-500 transition-colors resize-none"
                rows="4"
              />
            <span className="text-lg font-story font-semibold text-gray-500">
